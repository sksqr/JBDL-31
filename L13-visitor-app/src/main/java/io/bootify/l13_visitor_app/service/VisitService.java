package io.bootify.l13_visitor_app.service;
...
import io.bootify.l13_visitor_app.domain.Visitor;
import io.bootify.l13_visitor_app.model.VisitDTO;
import io.bootify.l13_visitor_app.model.VisitStatus;
import io.bootify.l13_visitor_app.repos.FlatRepository;
import io.bootify.l13_visitor_app.repos.UserRepository;
import io.bootify.l13_visitor_app.repos.VisitRepository;
import io.bootify.l13_visitor_app.repos.VisitorRepository;
...
public class VisitService {
    ...
    public List<VisitDTO> getPendingVisits(Long userId){
        ...
        return visitRepository.findByFlatAndStatus(flat,VisitStatus.PENDING)
                .stream()
                .map(visit -> mapToDTO(visit, new VisitDTO()))
                .collect(Collectors.toList());
    }
